...
impl Fighter2D {
    pub(super) fn enter_attack_helm_breaker(&mut self) {
        self.state = FighterState::AttackHelmBreaker;
        ...
        self.play_anim("attack_helm_breaker");
    }

    pub(super) fn process_attack_helm_breaker(&mut self, delta: f64) {
