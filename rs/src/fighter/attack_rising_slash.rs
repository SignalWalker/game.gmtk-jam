...
impl Fighter2D {
    pub(super) fn enter_attack_rising_slash(&mut self) {
        self.state = FighterState::AttackRisingSlash;
        ...
        self.play_anim("attack_rising_slash");
    }

    pub(super) fn process_attack_rising_slash(&mut self, delta: f64) {
