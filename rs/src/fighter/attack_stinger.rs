...
impl Fighter2D {
    pub(super) fn enter_attack_stinger(&mut self) {
        self.state = FighterState::AttackStinger;
        ...
        self.play_anim("attack_stinger");
    }

    pub(super) fn process_attack_stinger(&mut self, delta: f64) {
